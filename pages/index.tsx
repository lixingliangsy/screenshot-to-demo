  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://screenshot-to-demo.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is SnapDemo?", "acceptedAnswer": {"@type": "Answer", "text": "SnapDemo drafts a clickable demo storyboard from a screenshot description."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "PMs, marketers, and founders who need a first-pass interactive walkthrough."}}, {"@type": "Question", "name": "Does it record video for me?", "acceptedAnswer": {"@type": "Answer", "text": "No. It plans hotspots and narration; you build the demo in your tool."}}, {"@type": "Question", "name": "What inputs do I need?", "acceptedAnswer": {"@type": "Answer", "text": "What the screenshot shows, audience, and the action you want viewers to take."}}, {"@type": "Question", "name": "Does it guarantee conversion?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is decision-support storyboarding, not a growth guarantee."}}, {"@type": "Question", "name": "Can it invent UI that is not in the shot?", "acceptedAnswer": {"@type": "Answer", "text": "No. Stay honest to the screenshot; flag missing screens separately."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">SnapDemo - definition</h2>
