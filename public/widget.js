 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="screenshot-to-demo" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "screenshot-to-demo";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "screenshot-to-demo") + "_chat_session";
